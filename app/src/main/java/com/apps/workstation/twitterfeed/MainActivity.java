package com.apps.workstation.twitterfeed;
...
import com.apps.workstation.twitterfeed.adapters.TweetAdapter;
import com.apps.workstation.twitterfeed.models.Tweet;
import com.apps.workstation.twitterfeed.tasks.GetTweetsAsyncTask;
...
public class MainActivity extends ListActivity implements AdapterView.OnItemSelectedListener{
    ...
    final Integer[] refreshIntervalItems = new Integer[]{15, 30};
    ...
    private Runnable refreshTweetsRunnable = new Runnable() {
        ...
        public void run() {
            ...
            refreshTweetsHandler.postDelayed(this, refreshInterval*100000);
        }
    };
}
